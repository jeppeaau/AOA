% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% This script analyses the results of the
% AoA test 2, the field test. It will
% plot the points in a graph, as well
% as the moving average for the specified
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clc; clear; close all;
...
if f1~=-1
    ...
    plot(t,aoa_average,'k');
    xlabel('Time (s)');
    ylabel('Angle (deg)');
    legend('Angle of arrival','Average');
    xlim([0 max(t)]);
    ylim([0 180]);
